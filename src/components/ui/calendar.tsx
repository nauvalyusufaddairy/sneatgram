  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-bg10 text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-bg10 focus:text-bg60",
        ...
        Dropdown: (props) => {
          ...
          if (props.name === "months") {
            ...
            return (
              ...
              >
                <SelectTrigger className="bg-inputBg text-inputTextColor border-[1px] border-inputBorder focus:border-[1px] focus:border-bg10/40">
            ...
            if (earliestYear && latestYear) {
              ...
              selectYears = Array.from({ length: yearsLength }, (_, i) => ({
